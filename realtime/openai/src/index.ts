...
import { MastraRealtime } from '@mastra/core/realtime';
 ...
 * ```
 */
export class OpenAIRealtime extends MastraRealtime {
  ...
  private speaker: Realtime.Voice;
   ...
   * ```
   */
  private updateConfig(sessionConfig: unknown): void {
