...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  <Tabs.Tab>
  ```bash copy
npm install mastra@latest @mastra/core@latest
    ```
   </Tabs.Tab>
  <Tabs.Tab>
  ```bash copy
yarn add mastra@latest @mastra/core@latest
    ```
   </Tabs.Tab>
  <Tabs.Tab>
  ```bash copy
pnpm add mastra@latest @mastra/core@latest
  ```
  </Tabs.Tab>
<Tabs.Tab>
  ```bash copy
bun add mastra@latest @mastra/core@latest
  ```
  </Tabs.Tab>
</Tabs>
