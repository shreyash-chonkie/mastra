Variable mapping allows explicit mapping of values for the inputs of the next step. These values can come from a number of sources:
...
One use case for variable mappings is renaming outputs to match inputs:
