...
<CardItems titles={["Agent", "Workflow", "vNextWorkflow", "Memory", "RAG", "Storage", "Evals", "Voice"]} items={
  {
    Agent: [
      {
  ...
  Storage: [
    {
      title: "LibSQL",
      href: "/examples/storage/libsql",
    },
    {
      title: "Postgres",
      href: "/examples/storage/postgres",
    },
    {
      title: "Cloudflare KV",
      href: "/examples/storage/cloudflare-kv",
    },
    {
      title: "Cloudflare D1",
      href: "/examples/storage/cloudflare-d1",
    },
    {
      title: "Upstash",
      href: "/examples/storage/upstash",
    }
  ],
  Voice: [
    {
