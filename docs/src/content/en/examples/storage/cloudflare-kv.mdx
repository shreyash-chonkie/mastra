---
title: "Example: Using Cloudflare KV as a Storage Engine | Storage | Mastra Docs"
description: Example of using Cloudflare KV as a storage engine for Mastra.
---

# Cloudflare KV as a Storage Engine

This example demonstrates how to use Cloudflare KV as a storage engine for Mastra.

## Setup

```sh copy
npm install @mastra/cloudflare @mastra/core @ai-sdk/openai
```
...
export const mastra = new Mastra({
  ...
  storage: new CloudflareStore({
    // you can get your account_id and api_token from the cloudflare dashboard (dash.cloudflare.com)
