---
title: "Example: Using Cloudflare D1 as a Storage Engine | Storage | Mastra Docs"
description: Example of using Cloudflare D1 as a storage engine for Mastra.
---

# Cloudflare D1 as a Storage Engine

This example demonstrates how to use Cloudflare D1 as a storage engine for Mastra.

## Setup

```sh copy
npm install @mastra/cloudflare-d1 @mastra/core @ai-sdk/openai
```
...
```ts showLineNumbers copy filename="src/mastra/agents/index.ts"
...
## Register Agent and Workflow instances with Mastra class and Execute
...
export const mastra = new Mastra({
  ...
  storage: new D1Store({
    // you can get your account_id, database_id and api_token from the cloudflare dashboard (dash.cloudflare.com)
    // Account Home -> 3 dots beside your account name -> Copy Account ID -> Account API Tokens -> Create Token
    accountId: "your_account_id",
    apiToken: "your_api_token",
    // you can get your database_id from the cloudflare dashboard (dash.cloudflare.com)
    // Storage & Databases -> D1 SQL Database -> select your database -> copy database_id
