---
title: "Example: Using PostgreSQL as a Storage Engine | Storage | Mastra Docs"
description: Example of using PostgreSQL as a storage engine for Mastra.
---

# PostgreSQL as a Storage Engine

This example demonstrates how to use PostgreSQL as a storage engine for Mastra.

## Setup

```sh copy
npm install @mastra/pg @mastra/core @ai-sdk/openai
```
