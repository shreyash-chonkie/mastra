---
title: "Example: Using Upstash as a Storage Engine | Storage | Mastra Docs"
description: Example of using Upstash as a storage engine for Mastra.
---

# Upstash (Redis) as a Storage Engine

This example demonstrates how to use Upstash as a storage engine for Mastra.

## Setup

```sh copy
npm install @mastra/upstash @mastra/core @ai-sdk/openai
```
...
export const mastra = new Mastra({
  ...
  storage: new UpstashStore({
    // you can get your url and token from the upstash dashboard (console.upstash.com)
