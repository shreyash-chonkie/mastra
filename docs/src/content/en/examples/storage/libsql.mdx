---
title: "Example: Using LibSQL as a Storage Engine | Storage | Mastra Docs"
description: Example of using LibSQL as a storage engine for Mastra.
---

# LibSQL as a Storage Engine

This example demonstrates how to use LibSQL as a storage engine for Mastra.

## Setup

```sh copy
npm install @mastra/libsql @mastra/core @ai-sdk/openai
```
...
export const mastra = new Mastra({
  ...
  // LibSQL is a local file-based database
