...
After the prompts, `create-mastra` will set up your project directory with TypeScript, install dependencies (including the appropriate AI SDK package for your chosen LLM provider), and configure your selected components and LLM provider.
