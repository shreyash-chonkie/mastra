...
class MyVoiceProvider extends MastraVoice {
  ...
  async listen(audioStream: NodeJS.ReadableStream, options?: any): Promise<string | NodeJS.ReadableStream | void> {
...
<PropertiesTable
  content={[
    ...
    {
      name: "realtimeConfig",
      type: "{ model?: string; apiKey?: string; options?: any } | undefined",
      description: "Configuration for real-time speech-to-speech capabilities",
      isOptional: true,
    },
  ]}
