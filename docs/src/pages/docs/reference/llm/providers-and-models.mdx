...
| ------------- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OpenAI        | OPEN_AI         | `gpt-4`, `gpt-4-turbo`, `gpt-3.5-turbo`, `gpt-4o-mini`, `gpt-4o-mini`, `o1`, `o1-mini`, `o1-preview`                                                                             |
...
import { ModelRouter } from "@mastra/core/llm/router";
import { createOllama } from "ollama-ai-provider";
...
const ollamaLLM = new ModelRouter({
