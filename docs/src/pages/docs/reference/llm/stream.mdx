---
title: "Reference: ModelRouter.stream() | Streaming | LLM | Mastra Docs"
description: "Documentation for the `.stream()` method in ModelRouter, which enables real-time streaming of responses."
---
