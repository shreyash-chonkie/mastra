---
title: "Reference: ModelRouter.generate() | Generation | LLM | Mastra Docs"
description: "Documentation for the `.generate()` method in ModelRouter, which produces text or structured responses."
---
