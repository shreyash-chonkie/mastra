...
```typescript
import { ElevenLabsTTS } from "@mastra/tts/elevenlabs";
...
```typescript
import { OpenAITTS } from "@mastra/tts/openai";
...
```typescript
import { PlayAITTS } from "@mastra/tts/playai";
...
```typescript
import { AzureTTS } from "@mastra/tts/azure";
...
```typescript
import { DeepgramTTS } from "@mastra/tts/deepgram";
...
```typescript
import { GoogleTTS } from "@mastra/tts/google";
...
```typescript
import { IbmTTS } from "@mastra/tts/ibm";
...
```typescript
import { MurfTTS } from "@mastra/tts/murf";
