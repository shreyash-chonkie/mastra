...
When inspecting an agent in the playground, you'll see key information about the agent including:

- Agent ID and instructions
- Model provider (e.g., OPENAI, ANTHROPIC)
- Available tools and their descriptions
- Memory configuration

The provider information shows both the specific model being used and the provider platform (displayed in uppercase, e.g., "OPENAI" for OpenAI models).
