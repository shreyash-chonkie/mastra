...
The agent chat interface includes:
- A chat history sidebar showing all your conversations with each agent
- The ability to create new chat threads using the "+" button
- A main chat area for interacting with the selected agent
- Real-time streaming of agent responses

Each chat thread maintains its own conversation history, allowing you to test different scenarios or contexts with the same agent.
