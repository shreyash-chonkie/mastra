...
> **Reference Docs:**
>
> - [Workflow Overview](/docs/workflows/00-overview) - Learn more about workflows
> - [Workflow Guide](/docs/guides/04-recruiter) - Learn how to use workflows in a recruiter example
...
<GithubLink
  link={
    "https://github.com/mastra-ai/mastra/blob/main/examples/basics/agents/using-a-workflow"
  }
/>
