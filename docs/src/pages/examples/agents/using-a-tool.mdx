...
> **Reference Docs:**
>
> - [Agents Guide](/docs/agents/00-overview) - Learn about creating and configuring agents
> - [Adding Tools](/docs/agents/02-adding-tools) - Detailed guide on creating and using tools
> - [createTool API](/docs/reference/agents/createTool) - API reference for the createTool function
