...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description: "Logger instance for workflow execution details",
    },
    {
      name: "triggerSchema",
      type: "ZodSchema",
      isOptional: true,
      description: "Schema for validating workflow trigger data",
    },
    {
      name: "retryConfig",
      type: "RetryConfig",
...
Allows you to [configure](./config.mdx) a workflow [step](./step.mdx).
...
[Executes](./execute.mdx) the workflow with an optional trigger data. Typed based on the [trigger schema](./workflow.mdx#trigger-schemas).
