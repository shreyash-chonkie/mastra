  ...
  return (
    <T id="components.github_link.0">
      <a
        ...
        className="flex flex-row justify-between p-3 my-2 border border-gray-300 dark:border-[#404040] rounded-md cursor-pointer group text-zinc-900 dark:text-zinc-50"
        href={link}
      >
