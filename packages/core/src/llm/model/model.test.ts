...
describe('MastraLLM', () => {
  ...
  const mockTools = {
    testTool: makeCoreTool(
      ...
      { container, name: 'testTool', logger: mockMastra.logger },
    ),
  };
  ...
  describe('__textObject', () => {
    it('should generate structured output with Zod schema', async () => {
      ...
      const result = await aisdkObject.__textObject<any>({
        messages,
        container,
    ...
    it('should handle array type schemas', async () => {
      ...
      await aisdkArray.__textObject<any>({
        messages,
        container,
    ...
    it('should handle JSON schema input', async () => {
      ...
      await aisdkObject.__textObject<any>({
        messages,
        container,
  ...
  describe('__streamObject', () => {
    it('should stream object with Zod schema', async () => {
      ...
      await aisdkObject.__streamObject<any>({
        messages,
        tools: mockTools,
        container,
        structuredOutput: schema,
