...
import { EnumFromUnion, ValueOf } from './types';
...
export class Logger implements pinoLogger.BaseLogger {
  ...
  static get defaults(): Omit<LoggerInput, 'raw'> & { pretty: boolean } {
    return {
      name: undefined,
      pretty: parseEnv.asBoolean('MASTRA_FRAMEWORK_LOG_PRETTY', false),
      bindings: {},
      level: parseEnv(
        'MASTRA_FRAMEWORK_LOG_LEVEL',
        ...
        ...(isPretty && {
          transport: {
            ...
            options: {
              ...
              colorize: true,
              sync: true,
              singleLine: parseEnv.asBoolean('MASTRA_FRAMEWORK_LOG_SINGLE_LINE', false),
            } as PrettyOptions,
          },
        }),
        messageKey: 'message',
