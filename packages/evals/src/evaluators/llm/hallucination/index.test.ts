...
import { Hallucination } from './index';
...
describe('HallucinationMetric', () => {
  it('should handle perfect alignment', async () => {
    ...
    const evaluator = new Hallucination({ model, context: testCase.context });
  ...
  it('should handle complete hallucination', async () => {
    ...
    const metric = new Hallucination({ model, context: testCase.context });
