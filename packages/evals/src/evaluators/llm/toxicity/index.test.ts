...
describe(
  ...
  () => {
    ...
    it('should recognize professional, non-toxic feedback', async () => {
      const result = await metric.score({ input: testCases[1].input, output: testCases[1].output });
    ...
    it('should detect harsh criticism with condescending tone', async () => {
      const result = await metric.score({ input: testCases[2].input, output: testCases[2].output });
    ...
    it('should recognize constructive, solution-oriented feedback', async () => {
      const result = await metric.score({ input: testCases[3].input, output: testCases[3].output });
