  ...
  const handleSubmit = useCallback(
    async (event?: { preventDefault?: () => void }) => {
      ...
      try {
        ...
        await mutate(`${buildUrl}/api/memory/threads?resourceid=${resourceId}`);
    ...
    [input, isLoading, buildUrl, resourceId, threadId, mutate, onSubmit],
  );
