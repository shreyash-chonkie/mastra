...
export const providerMapToIcon = {
  'openai.chat': (
    <svg className="w-3 h-3" viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg" fill="white">
              ...
              columns={[
...

                {
                  ...
                  cell: ({ row }) => {
                    return (
                      <button
                        className="flex items-center justify-end w-full h-full p-4"
                        onClick={() => {
                          navigate(`/agents/${row.original.id}/chat`);
                        }}
                      >
                        <span className="flex items-center gap-2 text-sm text-mastra-el-5">
